...
import { transactionCheckout } from "@/app/services/transaction";
...
export default function PaymentStep() {
  ...
  const handleConfirmPayment = async () => {
    ...
    try {
      const formData = new FormData(); // Gunakan FormData saat metode POST nya juga form
      ...
      formData.append("image", file); // paymentProof
      formData.append(
        "purchasedItems",
        JSON.stringify(
