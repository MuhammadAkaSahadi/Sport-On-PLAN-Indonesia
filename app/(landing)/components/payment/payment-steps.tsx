      ...
      <CardWithHeader title="Payment Steps">
        <div className="p-5">
          <ol className="list-decimal  text-xs pl-2 flex flex-col gap-4 mb-5">
            <li>
              Transfer the total amount of <b>Rp. 1.035.000</b> to your
              preferred bank account listed under `Payment Options` (BCA,
              Mandiri, or BTPN).
            </li>
            <li>
        ...
        <div className="border-t border-gray-200 p-4">
          <div className="flex justify-between font-semibold mb-5">
            ...
            <div className="text-primary">{priceFormatter(45000)}</div>
          </div>
